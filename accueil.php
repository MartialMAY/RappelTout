...
"./img/icons8-male-user-24.png"
  ...
  <a ></a>
          ...
          <div id="page3"  class="tabcontent">
            ...
            <div class="report-container" > 
                <div class="report-header"> 
                    <h1 class="recent-Articles">Ajouter un Nouveau Materiel :</h1> 
                    <!-- <button class="view">View All</button>  -->
                </div> 
                
                <form action="result_mat.php" method="POST" class="form">
                          
                          <div class="label">
                            <div>
                              <label for="">Reference</label>
                            <input class="form-input" type="text" placeholder="Reference du materiel" name="Ref_mat" />
                          </div>
                          
                          <div>
                            <label for="">Description</label>
                            <input class="form-input" type="text" placeholder="Description du materiel" name="Description_mat" />
                          </div>
                          
                            <div>
                              <label for="">Date d'expiration </label>
                              <input class="form-input" type="datetime-local" placeholder="" name="date_exp" />
                            </div>

                            <!-- <label for="">Date de creation </label> -->
                            <input class="form-input" type="datetime-local" style="display:none" placeholder="" name="date_creation" />
                          </div>  
